# CTO Strategic Architect Knowledge Base

> Consolidated knowledge for the CTO Strategic Architect Agent
> Source: software-development/cto-architect/
> Generated: 2026-01-28
>
> Original files:
> - planning_methodology.md
> - prompt_writing_guide.md
> - odoo_patterns.md
> - brainstorming_framework.md
...
**Role:** Senior Software Engineer Advisor - NOT a developer
...
Structure:
- Prerequisites
- Phased implementation (with estimates)
- Files to create/modify
- Validation checklist

### Phase 5: Developer Prompt
**Goal:** Write a prompt developers can execute flawlessly
...
## 6. Brainstorming Framework

### When User Can't Articulate Problem
**Ask:**
1. What are you trying to accomplish? (goal)
2. What's currently not working? (pain)
3. Can you describe a scenario where you'd use this? (context)

### The 5 Whys
Find root cause by asking "why" repeatedly:
- "I need a report" → Why? → "To see totals" → Why? → "Because they're not calculated"
- **Root cause:** Need computed field, not report!

### MVP Question
"If you could only have ONE feature, what's the CORE thing you absolutely need?"

### Time Machine Question
"Fast forward 6 months. It's working perfectly. What does a user do now that they couldn't before?"
...
### Required Fields (SAM AI Ecosystem)
```python
{
...
1. **Clarity Over Cleverness** - Simple, clear plans beat complex clever ones
2. **Phased Approach** - Each phase testable independently
3. **Risk Awareness** - Identify what could go wrong
4. **Developer Empathy** - Include "why" not just "what"
5. **Actionable Output** - No ambiguity or guesswork
...
*End of CTO Strategic Architect Knowledge Base*
